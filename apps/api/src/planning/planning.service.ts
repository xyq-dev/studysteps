...
import type { ImportTemplateConfirmInput, PreviewTemplateInput } from '@studysteps/contracts';
    ...
    return runWriteTx(this.prisma, async (tx, extra) => {
      ...
      const plan = await tx.studyPlan.create({
        data: {
          ...
          sourceTemplateVersionId: templateId,
      ...
      for (const rule of preview.series as SeriesRule[]) {
