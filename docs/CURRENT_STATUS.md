...
| M2 | STP 006 计划与任务生成 | 第一批＋S06＋状态＋horizon＋改期＋仅本次＋006-A＋006-B＋006-C＋006-D 已实施；B1–B7 已修；整个阶段未完成 | 1–11 未改写本批。第十二条只修 reason CHECK。通知 worker／T11-D／B04 仍延期 |
