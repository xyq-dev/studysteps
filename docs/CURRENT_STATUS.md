...
| STP 006 | 第一批 `f0ffa10`。S06 `9a2c46f`。暂停／恢复／归档 `9274f2e`。horizon `ca0edb6`。改期 `1f3a4df`。本轮仅本次内容编辑，无第九条。未来规则／拆分／horizon 工人未做。不得标整个阶段完成 |
...
| M2 | STP 006 计划与任务生成 | 第一批＋S06＋状态＋horizon＋改期＋仅本次内容已实施；整个阶段未完成 | 八条已发布迁移未改。无第九条。未来规则／拆分／horizon 工人未做 |
...
2. STP 005：两个页面阻塞已关闭，产品验收未完成。STP 006 第一批＋S06＋状态＋horizon＋改期＋仅本次内容本轮提交，**不宣称整个阶段完成**。Playwright 不在 CI 工作流中。不得宣称 M0／STP 002／接口已冻结。
3. 本轮提交范围：仅本次内容编辑契约／API／H5／测试与文档。八条已发布迁移 checksum 未改，无第九条。原库与历史夹具保留。GitHub Actions 在 push 后跟踪。
